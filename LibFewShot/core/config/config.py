...
class Config(object):
    ...
    def _load_console_dict():
        ...
        parser.add_argument("-k_fold", "--k_fold", type=int, help="fold number for cross-validation evaluation")
    ...
    def _merge_config_dict(self):
        ...
        # eval configs
        if config_dict['eval_types'] is not None:
            config_dict['eval_types'] = config_dict['eval_types'].replace(' ', '').split(',')
