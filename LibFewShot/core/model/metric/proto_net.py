...
class ProtoLayer(nn.Module):
    ...
    def forward(
        ...
        if experimental:
            ...
            # (1, 25, 1600)
            # t, w, c
            proto_feat = torch.empty(1, 1, 1600).to(device='cuda')
            beg_idx = 0
...
class ProtoNet(MetricModel):
    ...
    def set_forward(self, batch):
        ...
        output_dict = self.evaluator.eval_batch(episode_size, support_feat, support_target, query_feat, query_target, self.k_fold)
